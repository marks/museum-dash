...
dataset_resource_id = "dyik-sdjy"
soda_client = SODA::Client.new({
  domain: "brigades.opendatanetwork.com",
...
SCHEDULER.every '5m', first_in: 0 do |job|
  ...
  #### TOTAL TICKETS ####
  total_tickets_response = soda_client.get(dataset_resource_id, {
    "$select" => "count(*)"
  })
  total_tickets = total_tickets_response.first["count"]
  send_event('total_tickets', { current:  total_tickets})
